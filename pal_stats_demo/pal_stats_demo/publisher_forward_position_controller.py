...
class PublisherForwardPosition(Node):
    def __init__(self):
        ...
        # Declare the pal_statistics registry
        self.pal_stats_registry = StatisticsRegistry("pal_stats_demo/introspection_data", self)
        self.i = 0
        self.pal_stats_registry.registerFunction(
            "current_goal_index", lambda: self.i)  # Register statistics function
    ...
    def timer_callback(self):
        ...
        self.pal_stats_registry.publish()  # Publish statistics
        self.i += 1
